...
def choice1_1():
    ...
    while(choiceinputted == False):
        ...
        if (choicevalue == "1"):
            ...
            print("You use your limited skills to attempt to trace the phone.\n")
            time.sleep(2)
            ...
            time.sleep(2)
            print("Just then you see spot a man with the exact same phone, a Sony Xperia Z5.\n")
            time.sleep(2)
            print("You pickpocket his phone are able to corroborate his recent terrorist activities and thoughts.\n")
            time.sleep(2)
            print("You learn that he is a high profile Doctor and the Hospital he works for has stakes in this particular airline and he was attempting to destabilise the market to decrease its price.\n")
            time.sleep(2)
            print("You realise it's a lot of work for a small, potential reward.\n")
            time.sleep(2)
            print("You quietly tell the stewardesses and are able to save the flight.\n")
            time.sleep(2)
            print("YOU WIN!\n")
            time.sleep(2)
        ...
        if(choicevalue == "3"):
            ...
            time.sleep(2)
            print("You slowly slip away in your sleep.\n")
            time.sleep(2)
            print("Oops, YOU DIED!\n")
...
def choice1():
    ...
    while(choiceinputted == False):
        ...
        if(choicevalue == "1"):
            ...
            time.sleep(2)
            print("I HAVE BECOME INCREASINGLY AWARE RECENTLY OF THE EXPENDABLE NATURE OF HUMANITY\n")
            time.sleep(2)
            ...
            time.sleep(2)
            print("You sustain a traumatic brain injury and DIE almost immediately.")
...
def main():
    ...
    while(choiceinputted == False):
        ...
        if(choicevalue == "1"):
            ...
            print("\nYou ask the lady next to you what has happened..\n")
            ...
            print("\nYou approach the stewardesses and ask them to explain what is happening..\n")
            print("The taller of the stewardesses glares at you and through gritted teeth,\n")
            time.sleep(2)
