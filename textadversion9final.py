...
def choice1_1():
    ...
    while(choiceinputted == False):
        ...
        if (choicevalue == "1"):
            ...
            time.sleep(2)
            print("Just then you see the Doctor with the exact. Same. Phone.\n")
            time.sleep(2)
            print("You pickpocket his phone are able to corroborate his recent terrorst activities and thoughts.")
            time.sleep(2)
            print("Apparently the Hospital he works for has stakes in this particular airline and he was attempting to destabilise the market to decrease its price.")
            time.sleep(2)
